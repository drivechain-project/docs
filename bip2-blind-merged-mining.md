...
This would consist of (for the most recent X=4000 blocks):
    ...
    1. Reusable data (common to all sidechains)
        ...
        b. nSidechains   -- Total number of sidechains in existence, at this time.
...
The TxOut in question would include three arguments: (h*, this_blocknumber, {{side_timeout=200}}, timeout=500).
